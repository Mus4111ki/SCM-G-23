...
hangman=0
lists = [
    "PYTHON", "JAVASCRIPT", "HTML", "CSS", "JAVA", "PHP", "RUBY", "SWIFT", "KOTLIN",
    "C++", "GO", "TYPESCRIPT", "MYSQL", "SQL", "REACT", "ANGULAR", "NODEJS", "DJANGO",
    "FLASK", "LARAVEL", "WORDPRESS", "DRUPAL", "BOOTSTRAP", "JQUERY", "AJAX", "JSON",
    "XML", "DOCKER", "KUBERNETES", "GIT", "GITHUB", "BITBUCKET", "HEROKU", "AWS", "AZURE",
    "GCP", "DIGITALOCEAN", "VUEJS", "SASS", "LESS", "GRUNT", "GULP", "WEBPACK", "BABEL",
    "REDIS", "MONGODB", "POSTGRESQL", "LINUX", "UNIX", "WINDOWS", "MACOS", "UBUNTU", "CENTOS",
    "FIREFOX", "CHROME", "SAFARI", "EDGE", "INTERNETEXPLORER", "OPERA", "BLINK", "GECKO",
    "WEBKIT", "CORS", "JWT", "SSL", "TLS", "HTTPS", "HTTP2", "REST", "SOAP", "GRAPHQL",
    "API", "OAUTH", "OAUTH2", "RSA", "JWT", "WEBHOOK", "COOKIE", "SESSION", "LOCALSTORAGE",
    "COOKIES", "CACHING", "CDN", "CRUD", "MVC", "MVVM", "APIGATEWAY", "LOADBALANCER", "DOCKERCOMPOSE",
    "CONTAINERS", "MICROSERVICES", "KAFKA", "RABBITMQ", "REDIS", "MEMCACHED", "ELASTICSEARCH",
    "SPLUNK", "LOGSTASH", "KIBANA", "PROMETHEUS", "GRAFANA", "ZABBIX", "NAGIOS"
]
